...
<?php include 'includes/mail.html'; ?>
				    ...
				    <?php
				    	...
				    	if($vquery->num_rows > 0){
							...
							<div class="text-center">
					    		...
					    		<button onclick="loadHTML()" data-toggle="modal" class="btn btn-flat btn-primary btn-lg" style="margin-top:10px">Do You Want Confirmation Mail?</button>
                                <div id="content"></div>
								<script>
									function loadHTML() {
									...
									xhr.onreadystatechange = function() {
										...
										if (xhr.status === 200) {
											...
											contentDiv.innerHTML = "Failed to load HTML.";
										}
										}
									};

									xhr.open("GET", "mail.html", true);
									xhr.send();
									}
									</script>
					    	</div>
						    ...
						    <form method="POST" id="ballotForm" action="submit_ballot.php">
				        		...
				        		<div class="text-center">
					        		...
					        		<button type="submit" class="btn btn-primary btn-flat" name="vote" id="submitBtn"><i class="fa fa-check-square-o"></i>Submit</button>
